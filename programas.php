                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card mb-4">
                                <div class="card-header">
                                    <h6 class="m-0 font-weight-bold text-primary">Educación Inclusiva para Todos</h6>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-footer"><a class="btn btn-primary btn-sm" href="#!">Mas Informacio</a></div>
                            </div>

                            <!-- Basic Card Example -->
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Acceso a Oportunidades para Todos</h6>
                                </div>
                                <div class="card-body">
                                    <div class="d-flex justify-content-between tm-pt-45">
